                ...
                <ul class="pagination">
                    <c:choose>
                        ...
                        <c:when test="${page.hasPreviousPage}">
                            <li>
                                <a href="${APP_PATH}/emp?pg=1">首页</a>
                            </li>
                            <li>
                                <a href="${APP_PATH}/emp?pg=${page.prePage}"
                                   aria-label="Previous">
                    ...
                    <c:forEach var="navigatepageNum" items="${page.navigatepageNums}">
                        <c:choose>
                            <c:when test="${page.pageNum!=navigatepageNum}">
                                <li>
                                    <a href="${APP_PATH}/emp?pg=${navigatepageNum}">
                                            ${navigatepageNum}
                                    </a>
                                </li>
                            </c:when>
                    ...
                    <c:choose>
                        <c:when test="${page.hasNextPage}">
                            <li>
                                <a href="${APP_PATH}/emp?pg=${page.nextPage}"
                                   aria-label="Next">
                                    <span aria-hidden="true">&raquo;</span>
                                </a>
                            </li>
                            <li>
                                <a href="${APP_PATH}/emp?pg=${page.pages}">末页</a>
                            </li>
                        </c:when>
                        <c:otherwise>
                            <li class="disabled">
